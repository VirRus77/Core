...
namespace Core.Converters
{
    ...
    public class KeyValue<TKey, TValue> : DependencyObject
    {
        public static readonly DependencyProperty KeyProperty =
            DependencyProperty.Register("Key", typeof(TKey), typeof(KeyValue<TKey, TValue>), new PropertyMetadata(default(TKey)));
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(TValue), typeof(KeyValue<TKey, TValue>), new PropertyMetadata(default(TValue)));
    ...
    public class KeyToValueConverter : DependencyObject, IValueConverter, IAddChild
    {
        public static readonly DependencyProperty DefaultValueProperty =
            DependencyProperty.Register("DefaultValue", typeof(object), typeof(KeyToValueConverter), new PropertyMetadata(default(object)));
